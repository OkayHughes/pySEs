...
class init:
  ...
  init_periodic_plane_grid = staticmethod(_periodic_plane.init_uniform_grid)
  exodus_to_pysces_grid_corners = staticmethod(_mesh_io.exodus_to_pyses_grid_corners)


class parallelism:
  shard_grid = staticmethod(_horizontal_grid.shard_grid)
  get_global_grid = staticmethod(_horizontal_grid.get_global_grid)
  make_grid_mpi_ready = staticmethod(_horizontal_grid.make_grid_mpi_ready)
